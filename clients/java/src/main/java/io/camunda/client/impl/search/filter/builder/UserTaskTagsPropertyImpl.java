...
import io.camunda.client.protocol.rest.UserTaskFilterTags;
import java.util.List;

public class UserTaskTagsPropertyImpl extends TypedSearchRequestPropertyProvider<UserTaskFilterTags>
    implements StringProperty {
  private final UserTaskFilterTags filterProperty = new UserTaskFilterTags();
  ...
  @Override
  protected UserTaskFilterTags getSearchRequestProperty() {
