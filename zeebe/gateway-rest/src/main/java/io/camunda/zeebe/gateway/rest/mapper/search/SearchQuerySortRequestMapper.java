...
import io.camunda.zeebe.gateway.protocol.rest.BatchOperationItemSearchQuerySortRequest;
import io.camunda.zeebe.gateway.protocol.rest.BatchOperationSearchQuerySortRequest;
import io.camunda.zeebe.gateway.protocol.rest.CorrelatedMessageSubscriptionSearchQuerySortRequest;
...
import io.camunda.zeebe.gateway.protocol.rest.ElementInstanceSearchQuerySortRequest;
import io.camunda.zeebe.gateway.protocol.rest.GroupClientSearchQuerySortRequest;
import io.camunda.zeebe.gateway.protocol.rest.GroupSearchQuerySortRequest;
import io.camunda.zeebe.gateway.protocol.rest.GroupUserSearchQuerySortRequest;
import io.camunda.zeebe.gateway.protocol.rest.IncidentSearchQuerySortRequest;
import io.camunda.zeebe.gateway.protocol.rest.JobSearchQuerySortRequest;
import io.camunda.zeebe.gateway.protocol.rest.MappingRuleSearchQuerySortRequest;
import io.camunda.zeebe.gateway.protocol.rest.MessageSubscriptionSearchQuerySortRequest;
import io.camunda.zeebe.gateway.protocol.rest.ProcessDefinitionInstanceStatisticsQuerySortRequest;
import io.camunda.zeebe.gateway.protocol.rest.ProcessDefinitionInstanceVersionStatisticsQuerySortRequest;
...
import io.camunda.zeebe.gateway.protocol.rest.RoleClientSearchQuerySortRequest;
import io.camunda.zeebe.gateway.protocol.rest.RoleGroupSearchQuerySortRequest;
import io.camunda.zeebe.gateway.protocol.rest.RoleSearchQuerySortRequest;
import io.camunda.zeebe.gateway.protocol.rest.RoleUserSearchQuerySortRequest;
import io.camunda.zeebe.gateway.protocol.rest.SortOrderEnum;
import io.camunda.zeebe.gateway.protocol.rest.TenantClientSearchQuerySortRequest;
import io.camunda.zeebe.gateway.protocol.rest.TenantGroupSearchQuerySortRequest;
import io.camunda.zeebe.gateway.protocol.rest.TenantSearchQuerySortRequest;
import io.camunda.zeebe.gateway.protocol.rest.TenantUserSearchQuerySortRequest;
